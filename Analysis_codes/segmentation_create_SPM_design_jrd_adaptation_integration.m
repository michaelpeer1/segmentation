function segmentation_create_SPM_design_jrd_adaptation_integration(psychopy_log_filename, output_mat_filename)
% Create segmentation adaptation design
% Regressors:
% 1. Repeat of the same stimulus
% 2. All stimuli appearances that are not repeats
% Parametric modulation of regressor 2 - Euclidean distance between stimulus and previous one
