function segmentation_create_SPM_design_objview_adaptation_integration(psychopy_log_filename, output_mat_filename)
...
% Parametric modulation of regressor 3 - Euclidean distance between stimulus and previous one
